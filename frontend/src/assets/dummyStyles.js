...
export const loginStyles = {
  ...
  // Back button
backButton:
  "absolute top-5 left-4 sm:top-6 sm:left-6 flex items-center gap-2 text-gray-700 bg-white/70 backdrop-blur-sm px-4 py-2 rounded-full shadow-md hover:scale-105 hover:bg-white hover:text-indigo-600",

backButtonIcon:
  "w-4 h-4 flex-shrink-0 text-gray-700",
