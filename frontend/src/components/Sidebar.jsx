...
const Sidebar = () => {
  ...
  // if inner width is greater than 768px then it will call this func
  useEffect(() => {
    const handleResize = () => {
  ...
  //if the sidebar is open and inner widht is less than 768px then it will collapse
  ...
  //this func wiill handle what u select the touch
  const handleTechSelect = (techId) => {
    if (selectedTech === techId) {
      setSelectedTech(null); // all the intitial values are defined here
  ...
  const toggleSidebar = () => setIsSidebarOpen((prev) => !prev); //togle sidebar for small screen
  ...
  return (
    <div className={sidebarStyles.pageContainer}>
      ...
      <div className={sidebarStyles.mainContainer}>
          ...
          <div className={sidebarStyles.sidebarHeader}>
            ...
            <div className={sidebarStyles.headerContent}>
              <div className={sidebarStyles.logoContainer}>
                ...
                <div>
                  <h1 className={sidebarStyles.logoTitle}>Tech Quiz Web App</h1>
        ...
        {/** questions and answer also result */}
